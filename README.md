...
<h4>
  ...
  <a href="abujamal@hacxgpt.com">Contact</a>
...
- ✄1¤7 **Open-source CLI tool** for interacting with AI models

- ✄1¤7 **Custom Local API Engine** - Zero dependency on third-party SDKs like `openai` or `litellm`

- ✄1¤7 **Access to multiple providers** - OpenRouter, Groq, and HacxGPT API

- ✄1¤7 **Advanced jailbreak prompts** that reduce model censorship

- ✄1¤7 **Multi-provider support** with easy switching between services

- ✄1¤7 **Cross-platform compatibility** - Linux, Windows, macOS, Termux

- ✄1¤7 **Local API key storage** - your keys never leave your machine

- ✄1¤7 **Free to use** - just bring your own API keys from providers
...
- ❄1¤7 This code itself is not a custom AI model

- ❄1¤7 Not a paid service - completely free and open source

- ❄1¤7 Does not collect or store your data

- ❄1¤7 Does not require payment to use the CLI tool
...
- ✄1¤7 Free for personal use

- ✄1¤7 Open source for learning and contribution

- ✄1¤7 Can be forked and modified for personal projects
...
[⭄1¤7 Star this repo](https://github.com/HacxGPT-Official/HacxGPT-CLI)  1¤7 [🐛 Report bug](https://github.com/HacxGPT-Official/HacxGPT-CLI/issues)  1¤7 [💡 Request feature](https://github.com/HacxGPT-Official/HacxGPT-CLI/issues)
